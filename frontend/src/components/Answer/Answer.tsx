        ...
        <>
            <Stack className={styles.answerContainer} tabIndex={0}>
                ...
                <Stack.Item className={styles.answerDisclaimerContainer}>
                    <span className={styles.answerDisclaimer}>This content has been generated by artificial intelligence. While we strive for accuracy and quality, please note that the information provided may contain errors or inaccuracies. The user is solely responsible for the use and interpretation of this content.</span>
                </Stack.Item>
                </Stack>
                {chevronIsExpanded && 
